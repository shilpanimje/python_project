...
from python_crud.connectors import sentry


@patch('python_crud.connectors.sentry.raven.Client', return_value='sentry_client')
@patch('python_crud.connectors.sentry.config')
...
@patch('python_crud.connectors.sentry.sentry_client')
